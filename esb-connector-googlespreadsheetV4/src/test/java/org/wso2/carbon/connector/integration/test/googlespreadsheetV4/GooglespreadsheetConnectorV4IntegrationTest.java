...
package org.wso2.carbon.connector.integration.test.googlespreadsheetV4;
...
public class GooglespreadsheetConnectorV4IntegrationTest  extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        init("googlespreadsheetV4-connector-1.0.0");
    ...
    public void testEditMultipleCellWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + "/values:batchUpdate?fields="
                + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_editMultipleCellMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testCreateSpreadsheetWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "createSpreadsheetMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + esbRestResponse.getBody().get("spreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    }
    ...
    public void testCreateSpreadsheetWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:createSpreadsheet");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createSpreadsheetOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + esbRestResponse.getBody().get("spreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void testGetSheetMetaDataWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") +
                "?includeGridData=" + connectorProperties.getProperty("includeGridData") +"&fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    ...
    public void testGetSheetMetaDataWithOptionalParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") +
                "?includeGridData=" + connectorProperties.getProperty("includeGridData") +"&fields=" + connectorProperties.getProperty("fieldSpreadsheetId")
                + "&ranges=" + connectorProperties.getProperty("ranges1")+ "&ranges=" + connectorProperties.getProperty("ranges2");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    ...
    public void testAddSheetBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_addSheetBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    }
    /**
    ...
    public void testAddSheetBatchRequestWithOptionalParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_addSheetBatchRequestOptional.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    }
    /**
    ...
    public void testUpdateSheetPropertiesBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateSheetPropertiesBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateSheetPropertiesBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testUpdateSheetPropertiesBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:updateSheetPropertiesBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "updateSheetPropertiesBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testUpdateSheetPropertiesBatchRequestWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:updateSheetPropertiesBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "updateSheetPropertiesBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateSheetPropertiesBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void testAddConditionalFormatRuleBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "addConditionalFormatRuleBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_addConditionalFormatRuleBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testAddConditionalFormatRuleBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:addConditionalFormatRuleBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "addConditionalFormatRuleBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testAddRowsColumnsDataWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "addRowsColumnsDataMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + "/values/" + connectorProperties.getProperty("rangeaddRows") + ":append?valueInputOption="
                + connectorProperties.getProperty("valueInputOptionaddRows") +"&fields="  + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    ...
    public void testAddRowsColumnsDataWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_addRowsColumnsDataOptional.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testAppendDimensionBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_appendDimensionBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_appendDimensionBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testAppendDimensionBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:appendDimensionBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "appendDimensionBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testAppendDimensionBatchRequestWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:appendDimensionBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "appendDimensionBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_appendDimensionBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void testAutoResizeDimensionsBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_autoResizeDimensionsBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_autoResizeDimensionsBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testAutoResizeDimensionsBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:autoResizeDimensionsBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "autoResizeDimensionsBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testAutoResizeDimensionsBatchRequestWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:autoResizeDimensionsBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "autoResizeDimensionsBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_autoResizeDimensionsBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void testCopyPasteBatchRequestWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_copyPasteBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testCutPasteBatchRequestWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_cutPasteBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testDeleteDimensionBatchRequestWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_deleteDimensionBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testDeleteDimensionBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:deleteDimensionBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "deleteDimensionBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testEditCellWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + "/values/" + connectorProperties.getProperty("rangeEditCell") + "?valueInputOption="
                + connectorProperties.getProperty("valueInputOptionEditCell") +"&fields="  + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testEditCellWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:editCell");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_editCellOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + "/values/" + connectorProperties.getProperty("rangeEditCell") + "?valueInputOption="
                + connectorProperties.getProperty("valueInputOptionEditCell") +"&fields="  + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "PUT", apiRequestHeadersMap, "api_editCellOptional.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testGetCellDataWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "getCellDataMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") +
                "/values/" + connectorProperties.getProperty("rangeGetCellData") + "?fields="
    ...
    public void testInsertDimensionBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_insertDimensionBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_insertDimensionBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testInsertDimensionBatchRequestWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:insertDimensionBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "insertDimensionBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_insertDimensionBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void testMergeCellsBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_mergeCellsBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testMergeCellsBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:mergeCellsBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "mergeCellsBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testMoveDimensionBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_moveDimensionBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testRepeatCellsBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_repeatCellsBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testSetDataValidationBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_setDataValidationBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testSetDataValidationBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:setDataValidationBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "setDataValidationBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testUpdateBordersBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateBordersBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testUpdateBordersBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:updateBordersBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "updateBordersBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testUpdateCellsBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateCellsBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testupdateCellsBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:updateCellsBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "updateCellsBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testUpdateConditionalFormatRuleBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateConditionalFormatRuleBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
    ...
    public void testUpdateConditionalFormatRuleBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:updateConditionalFormatRuleBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "updateConditionalFormatRuleBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testUpdateDimensionPropertiesBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateDimensionPropertiesBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateDimensionPropertiesBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testUpdateDimensionPropertiesBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:updateDimensionPropertiesBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "updateDimensionPropertiesBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testUpdateDimensionPropertiesBatchRequestWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:updateDimensionPropertiesBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "updateDimensionPropertiesBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateDimensionPropertiesBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void testCopyToWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_copyToMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl")  + "/" + connectorProperties.getProperty("spreadsheetId") + "/sheets/" + connectorProperties.getProperty("sheetId")
                + ":copyTo?fields=sheetType";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_copyToMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("sheetType"), apiRestResponse.getBody().get("sheetType"));
    }
    /**
    ...
    public void testDeleteConditionalFormatRuleBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_deleteConditionalFormatRuleBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_deleteConditionalFormatRuleBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().get("spreadsheetId"), apiRestResponse.getBody().get("spreadsheetId"));
    }
    ...
    public void testDeleteConditionalFormatRuleBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:deleteConditionalFormatRuleBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "deleteConditionalFormatRuleBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 400);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    ...
    public void testDeleteConditionalFormatRuleBatchRequestWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:deleteConditionalFormatRuleBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "deleteConditionalFormatRuleBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_deleteConditionalFormatRuleBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 200);
    ...
    public void testDeleteSheetBatchRequestWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_deleteSheetBatchRequestMandatory.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_deleteSheetBatchRequestMandatory.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    }
    /**
    ...
    public void testDeleteSheetBatchRequestWithNegativeCase() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:deleteSheetBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "deleteSheetBatchRequestNegative.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId")
    ...
    public void testDeleteSheetBatchRequestWithOptionalParameters() throws Exception {
        esbRequestHeadersMap.put("Action", "urn:deleteSheetBatchRequest");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "deleteSheetBatchRequestOptional.json");
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/" + connectorProperties.getProperty("spreadsheetId") + ":batchUpdate?fields=" + connectorProperties.getProperty("fieldSpreadsheetId");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_deleteSheetBatchRequestOptional.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 400);
    }
}
